<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="租户描述符" prop="Identifier">
        <el-input v-model="queryParams.Identifier" placeholder="请输入租户描述符" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="租户描述符" prop="Identifier">
          <el-input v-model="form.Identifier" placeholder="请输入租户描述符" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除系统租户表编号为"' + Ids + '"的数据项？').then(function () {
